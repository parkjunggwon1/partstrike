				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<table width="99%" border="0" cellspacing="1" cellpadding="5" bgcolor="#e6e6e6">
							<tr>
								<td  width="150" align="center" bgcolor="#f6f6f6" class="btitle02">보증금 </td>
								<td bgcolor="#FFFFFF"> $<?=GetDeposit($idx, $rel_idx, "8")?>  </td>
								<td  width="150" align="center" bgcolor="#f6f6f6" class="btitle02">계약금 </td>
								<td bgcolor="#FFFFFF"> $<?=GetDeposit($idx, $rel_idx, "2,6")?>  </td>
								<td  width="150" align="center" bgcolor="#f6f6f6" class="btitle02"> My Bank  </td>
								<td bgcolor="#FFFFFF"> $<?=SumMyBank($idx, $rel_idx)?> </td>
								<td  width="150" align="center" bgcolor="#f6f6f6" class="btitle02">재고품목  </td>
								<td bgcolor="#FFFFFF"> <?=stock_cnt($idx, $rel_idx)?> </td>
							</tr>
						<table>
						<br>
						<?}?>
						<table width="99%" border="0" cellspacing="1" cellpadding="5" bgcolor="#e6e6e6">
							...
							<tr>
								...
								<td bgcolor="#FFFFFF" colspan="3"><?if($filereg_no){?>
							...
							<tr>
								...
								<a href="<?=$file_path?><?=$filestore3?>" target="_img">
								...
								<a href="<?=$file_path?><?=$filestore4?>" target="_img">
						...
						<br />
						<?
						include $_SERVER["DOCUMENT_ROOT"]."/admin/member/member_list_impship.php";
						?>
						<?
						include $_SERVER["DOCUMENT_ROOT"]."/admin/member/member_list_agency.php";
						?>
						<?
						include $_SERVER["DOCUMENT_ROOT"]."/admin/member/member_list_6.php";
						?>
						...
						<table width="99%" border="0" cellspacing="1" cellpadding="5" bgcolor="#e6e6e6">
							<tr>			
								<td  width="150" align="center" bgcolor="#f6f6f6" class="btitle02">탈퇴사유 </td>
								<td bgcolor="#FFFFFF"><textarea name="del_memo" rows="3" cols="150"><?=$del_memo?></textarea>
						...
						<table width="99%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<span class="btn1"><a href="javascript:black();">블랙리스트</a></span>
								<span class="btn1"><a href="javascript:del();">탈퇴확인</a></span>
...
<iframe name="proc" id="proc" width="0" height="0" frameborder="1"></iframe>
<?
