					...
					<tr>
						...
						<table width="99%" border="0" cellspacing="0" cellpadding="0" background="/admin/img/boardbar_bg.gif">
							<tr>
								...
								<td width="250" align="center" class="btitle01">Contact</td>
								<td width="250" align="center" class="btitle01">Address</td>
						...
						<table width="99%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<textarea name="nation" rows="5" cols="40"></textarea>
								</td>	
								<td width="250" align="center">
								<textarea name="tel1" rows="5" cols="40"></textarea>		
								</td>
								<td width="250" align="center">
								<textarea name="fax1" rows="5" cols="40"></textarea>
								</td>
								<td width="250" align="center">
								<textarea name="email1" rows="5" cols="40"></textarea>
								</td>
								<td width="250" align="center">
								...
								</td><td width="100" align="center"><span class="btn1"><a href="javascript: check('f','write','저장');">추가</a></span></td>
							</tr>
							<tr>
						...
						while($row = mysql_fetch_array($result)){
							...
							$contact = replace_out($row["contact"]);
							$address = replace_out($row["address"]);
						?>
						...
						<table width="99%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<<td height="50" align="center">
								<textarea name="nation" rows="5" cols="40"><?=$nation?></textarea>
								</td>	
								<td width="250" align="center">
								<textarea name="tel1" rows="5" cols="40"><?=$tel1?></textarea>		
								</td>
								<td width="250" align="center">
								<textarea name="fax1" rows="5" cols="40"><?=$fax1?></textarea>
								</td>
								<td width="250" align="center">
								<textarea name="email1" rows="5" cols="40"><?=$email1?></textarea>
								</td>
								<td width="250" align="center">
								<textarea name="contact" rows="5" cols="40"><?=$contact?></textarea>
								</td>
								<td width="250" align="center">
								<textarea name="address" rows="5" cols="40"><?=$address?></textarea>
