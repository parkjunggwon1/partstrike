...
<!--
	...
	function submitImageUploadForm(uploadForm)	{
		...
		theFrm.imagepath.value = opener.parent.imagepath;
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="fileuploader_pro.php" method="post" enctype="multipart/form-data" onSubmit="return false;">
		<input type="hidden" name="imagepath">
		<input type="hidden" name="id" value="<?=$id?>">
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox" name="update_image" style="width:280px;">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:submitImageUploadForm(document.getElementById('editor_upimage'));"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm100"></a>
            <a href="#"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel" onclick="self.close();"></a>
			<a href="#"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="확인" id="btn_confirm" style="display:none;"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
