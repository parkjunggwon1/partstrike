...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=0,top=0,width=380,height=250,scrollbars=no,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "./photo_uploader/popup/photo_uploader.php?id=" + this.oApp.sAppId;
