<table width="200" border="0" cellspacing="1" cellpadding="4" bgcolor="#8e9194">
  <tr>
    <td align="center" bgcolor="#63676a"><table width="192" border="0" cellpadding="0" cellspacing="0">
      <tr>
          ...
          <td align="center" bgcolor="#FFFFFF"><!--왼쪽메뉴시작-->
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" background="/admin/img/sub_t03.gif">
              <tr>
                ...
                <td style="padding-left: 10px" class="left01">COMPANY</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<a href="/admin/board/board_list.php?mode=EE001">NOTICE</a></td>
              </tr>   
			...
			<!--
			 <table width="100%" border="0" cellspacing="0" cellpadding="0" background="/admin/img/sub_t03.gif">
              <tr>
                <td width="6"><img src="/admin/img/sub_t01.gif" width="6" height="25" /></td>
                <td style="padding-left: 10px" class="left01">CUSTOMERS</td>
                <td width="6" align="right"><img src="/admin/img/sub_t02.gif" width="6" height="25" /></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
                <td height="20" style="padding-left: 10px" ><img src="/admin/img/icon_01.gif" width="6" height="8" /> 
				<a href="/admin/board/board_list.php?mode=EE002">CLIENT LIST</a></td>
              </tr>   
			  <tr>
                <td height="20" style="padding-left: 10px" ><img src="/admin/img/icon_01.gif" width="6" height="8" /> 
				<a href="/admin/board/board_list.php?mode=EE003">CASE STUDY</a></td>
              </tr>  			
            </table>    
			<br />
			-->
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
                <td height="20" style="padding-left: 10px" ><img src="/admin/img/icon_01.gif" width="6" height="8" /> 
				<a href="/admin/change/change.php">관리자 정보 변경</a></td>
              </tr>
            </table>
            -->
