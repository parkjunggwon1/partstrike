...
<div class="sheet-wrap">
	...
	<div class="order-table">
		...
		<table>
			...
			*/
						$mem_nm_en = get_want("member", "mem_nm_en", "and mem_idx='".$mybank["mem_idx"]."'");
						$pos_nm_en =  get_want("member", "pos_nm_en", "and mem_idx='".$mybank["mem_idx"]."'");
						
						$rel_idx= $mybank["rel_idx"];
						$amount = $mybank["charge_amt"];
						//if(!$mybank_idx){
							if($rel_idx!="0"){
