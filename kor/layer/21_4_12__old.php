...
<?
 ...
 $odr_det_idx =  $fty_his[odr_det_idx];
  ...
  if ($fty_his[buy_mem_idx]==$_SESSION["MEM_IDX"]){
	$confirm_yn = get_any("mybank", "chk", "odr_idx=".$fty_his[odr_idx]." and odr_det_idx=".$fty_his[odr_det_idx]." and charge_type=11 and charge_amt<0 and mem_idx=".$fty_his[buy_mem_idx]);	
  }else{
	  $confirm_yn = get_any("mybank", "chk", "odr_idx=".$fty_his[odr_idx]." and odr_det_idx=".$fty_his[odr_det_idx]." and charge_type=13 and charge_amt<0 and mem_idx=".$fty_his[sell_mem_idx]);
