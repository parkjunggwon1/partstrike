<?
/******************************************************************************************************
*** What's New : 반품 방법(구매자) 18R_16 (status:22)
******************************************************************************************************/
...
<SCRIPT Language="javascript">
	$(document).ready(function(){
		$("#data_18R_16 .stock-list-table tbody:eq(0) tr:eq(0) td").addClass("first");
	});
		...
		<table>
			<tbody>
				<tr>		
					...
					<td class="c-red2 w100 t-ct"><!--반품 방법 메세지가 없습니다.--></td>
				</tr>
			</tbody>
		</table>
	</div>	
<?}else{
	...
	<div class="layer-content">
		...
		<!-- //layer-pagination -->
		<?=GET_ODR_HISTORY_LIST("18R_16", $odr_idx,$odr_det_idx)?>
	</div>
	<!-- //layer-content -->
<?}?>
