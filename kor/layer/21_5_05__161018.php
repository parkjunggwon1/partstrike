...
?>
	<p class="txt-warning t-ct"><img src="/kor/images/top_logo.png" alt="PARTStrike" style="height:18px"></p>
		...
		<input type="text" class="i-txt2 c-blue t-rt" name ="account_no" id="account_no_21505" value="" style="width:92px;ime-mode:disabled;">
...
<input type="hidden" name="etc1" value="<?=GF_Common_GetSingleList("DLVR",$parts[company_idx])?>-<?=$parts[account_no]?>">
