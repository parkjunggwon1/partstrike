...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li><a href="#" class="buy-mn12">1</a></li>
			<li class="current"><a href="#" class="buy-mn12-19-2-04">2</a></li>
			<li><a href="#">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
	...
	<div class="layer-step">
		<ol>
			...
			<li>
				<span class="date">Day, Month, 2014</span>
				<strong class="status">수량 부족</strong>
				<span class="etc">3rd - <span lang="ko">추가 선적</span></span>
			</li>
			<li class="c2">
				<span class="date">Day, Month, 2014</span>
				<strong class="status">수량 부족</strong>
				<span class="etc">3rd - <span lang="ko">환불</span></span>
			</li>
		</ol>
	</div>
	<!-- //layer-step -->
	...
	<div class="layer-file">
		<table>
			<tbody>
				...
				<tr>
					<td>
						<div class="re-select"><strong>선택</strong><em>환불</em></div>
					</td>
