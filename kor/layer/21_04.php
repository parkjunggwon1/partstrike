...
/*************************************************************************************************************************
*** 불량통보 : 21_04
*** 2016-08-06 : 기존 PPT의 품목, 파일 첨부등 없애고, 제목 & 텍스트 에디터로 변경(2016-05-18 일자 PPT)
**************************************************************************************************************************/
...
<div class="layer-content">
	<form name="f6" id="f2104" method="post">
	<input type="hidden" name="typ" value="notify">
	...
	<div class="layer-data">
		<table class="stock-list-table" id="list_21_04">
			<tr  class="bg-none">
				<td class="t-lt">
					<strong class="c-black" Style="font-family:'굴림', sans-serif;">제목&nbsp;:&nbsp;&nbsp;</strong>
					<input type="text" name="title" class="i-txt5" value="" lang="kor" style="width:400px">
				</td>
			</tr>
			<tr  class="bg-none">
				<td class="edit-col">
					<textarea id="editor1" name="memo" rows="15" cols="140" class="ckeditor"></textarea>
				</td>
			</tr>
		</table>
	</div>
...
<!--
 ...
 $(document).ready(function(){
	...
	function check(){
		var f =  document.f6;
		if (nullchk(f.title,"제목을 입력해 주세요.")== false) return ;			
		f.typ.value="notify";
		var options = {
				success	: appAfter,
...
//							$(".myrecord").click();
	...
	function appAfter(objResponse, statusText, xhr, $form){
		if(statusText == "success"){
			if(trim(objResponse) == "SUCCESS"){
				alert_msg("<?=$sell_mem_idx == $session_mem_idx?"회신":($refuse_num==0?"회신요청":"답변");?> 하였습니다.");
				location.href="/kor/";
			} else {
				alert_msg(statusText);
			}
		}
	}
