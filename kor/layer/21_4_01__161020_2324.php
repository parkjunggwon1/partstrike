...
<div class="sheet-wrap">
	...
	<div class="btn-area t-rt"  odr_idx ="<?=$odr_idx?>"  odr_det_idx="<?=$odr_det_idx?>">
		...
		<a href="#" class="btn-view-sheet-21-4-06" odr_idx ="<?=$odr_idx?>"  odr_det_idx="<?=$odr_det_idx?>" tot_amt="<?=$tot_amt?>"><img src="/kor/images/btn_agree.gif" alt="동의"></a>
		<?}else{
			?>
