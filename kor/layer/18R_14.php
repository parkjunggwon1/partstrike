...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li><a href="#" class="sell-mn09">1</a></li>
			<li><a href="#" class="sell-mn09-18r-10">2</a></li>
			<li class="current"><a href="#" class="sell-mn09-18r-14">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
			<li><a href="#">7</a></li>
	...
	<div class="layer-file">
		<table>
			<tbody>
				...
				<tr>
					<td><div class="re-select"><strong>선택</strong><em>교환</em><!--<em>반품</em>--></div></td>
	...
	<div class="btn-area t-rt">
		<a href="#" class="btn-dialog-18R15"><img src="/kor/images/btn_exchange.gif" alt="교환"><!--<img src="/kor/images/btn_return.gif" alt="반품">--></a>
