			...
			<table>
				<tbody>
					...
					<tr>
						...
						<div class="select type4" style="width:70px">
							<label class="c-blue" lang="en">FEDEX</label>
							<select>
								<option label="en">FEDEX</option>
								<option label="en">FEDEX</option>
							</select>
						</div>
						 &nbsp;&nbsp;&nbsp;운송장번호: <input type="text" class="i-txt2 c-blue" value="XXXXXXXXX" style="width:96px"></td>
					</tr>
					<tr>
						<td><div class="re-select"><strong>선택</strong><em>추가 선적</em></div></td>
			...
			<table class="stock-list-table">
				...
				<tbody>
					...
					<tr>
						...
						<td>PackaPacka</td>
						<td><input type="text" class="i-txt4 c-red2" value="14" style="width:38px"></td>
						<td>RoHS</td>
						<td>$10,000.00</td>
						<td class="c-blue"><input type="text" class="i-txt4 c-red2" value="200" style="width:58px"></td>
						<td>Stock</td>
					</tr>
					<tr class="bg-none">
						<td></td>
						<td colspan="8">
							<table class="detail-table">
								<tbody>
									<tr>
										<th scope="row" style="width:50px">부품 상태  : </th>
										<td style="width:144px">
											<div class="select type4" style="width:110px">
												<label class="c-blue" lang="en">New &amp; Original</label>
												<select>
													<option lang="en">New &amp; Original</option>
													<option lang="en">New &amp; Original</option>
												</select>
											</div>
										</td>
										...
										<td colspan="2">
											<div class="select type4" style="width:77px">
												<label class="c-blue" lang="en">Original </label>
												<select>
													<option lang="en">Original </option>
													<option lang="en">Original </option>
												</select>
											</div>
											<div class="select type4" style="width:77px">
												<label class="c-blue" lang="en">Tape &amp; Reel</label>
												<select>
													<option lang="en">Tape &amp; Reel</option>
													<option lang="en">Tape &amp; Reel</option>
												</select>
											</div>
										</td>
									...
									<tr>
										<td colspan="5" lang="en"><strong class="c-red">Memo : </strong> <input type="text" class="i-txt2 c-blue" value="XXXXXXXXXXXXXXXXXXXX" style="width:294px"></td>
									</tr>
									<tr>
