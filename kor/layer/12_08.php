...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li><a href="#" class="sell-mn03">1</a></li>
			<li class="current"><a href="#" class="sell-mn03-1208">2</a></li>
			<li><a href="#">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
	...
	<div class="btn-area t-rt">
		<a href="#" class="btn-view-sheet-1207"><img src="/kor/images/btn_order_confirm.gif" alt="발주서 확인"></a>
	</div>
	<!-- //layer-btn -->
</div>
<!-- //layer-content -->