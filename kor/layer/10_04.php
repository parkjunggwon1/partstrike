...
$recordcnt = 1;
$searchand .= "and sell_mem_idx = ".$_SESSION["MEM_IDX"]." and status = $status and (confirm_yn = 'N' or fault_select = 'Y')"; 			
		...
		<table>
			<tbody>
				<tr>		
					...
					<td class="c-red2 w100 t-ct"><!--납기 연장 요청 건이 없습니다.--></td>
				</tr>
			</tbody>
		</table>
	</div>	
<?}else{
	...
	<div class="layer-content">
		...
		<!-- //layer-pagination -->
		<?=GET_ODR_HISTORY_LIST("10_04", $odr_idx)?>
	</div>
	<!-- //layer-content -->
<?}?>
