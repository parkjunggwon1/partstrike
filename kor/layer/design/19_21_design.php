...
<div class="layer-content">
	...
	<div class="layer-step">
		<ol>
			...
			<li>
				<span class="date">Day, Month, 2014</span>
				<strong class="status">수량 부족</strong>
				<span class="etc">3rd - 200EA</span>
			</li>
			<li class="c2">
				<span class="date">Day, Month, 2014</span>
				<strong class="status">추가<br>
				선적 완료</strong>
				<span class="etc"><img alt="DHL" src="/kor/images/icon_dhl.gif"><br>
				-XXXXXXXXX</span>
			</li>
		</ol>
	</div>
	...
	<div class="layer-file">
		<table>
			<tbody>
				<tr>
					<td class="c-red2">운송회사 : <img src="/kor/images/icon_dhl.gif" alt=""> &nbsp;&nbsp;&nbsp;운송장번호: <span lang="en" class="c-blue">XXXXXXXXX</span></td>
					<td class="t-rt">
				...
				<tr>
					<td>
						<div class="re-select"><strong>선택</strong><em>추가 선적</em></div>
					</td>
