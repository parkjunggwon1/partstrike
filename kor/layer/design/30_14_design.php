...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li class="current"><a href="#" class="buy-mn07">1</a></li>
			<li><a href="#" class="buy-mn07-18-2-15">2</a></li>
			<li><a href="#" class="buy-mn07-0122">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
			<li><a href="#">7</a></li>
	...
	<div class="layer-step">
		<ol>
			...
			<li>
				...
				<span class="etc"><span lang="ko">Mybank</span></span>
			</li>
		</ol>
	</div>
	<!-- //layer-step -->
	...
	<div class="layer-file">
		<table>
			<tbody>
				<tr>
					<td class="c-red2 t-ct">총 금액 (<strong class="c-blue"><span lang="en">US$0,000.00</span> – Mybank</strong>) 결제가 완료되었습니다.</td>
				</tr>
			</tbody>
		</table>
	</div>
