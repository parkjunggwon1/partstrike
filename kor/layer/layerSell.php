...
<div class="layer-left-menu">
	<ul>
		<li class="sell-mn01"><a href="#">납기<span class="count">385</span></a></li>
		<li class="sell-mn02"><a href="#">발주서<span class="count">127</span></a></li>
		<li class="sell-mn03"><a href="#">수정 발주서<span class="count">6</span></a></li>
		<li class="sell-mn04"><a href="#">납기 연장<span class="count">12</span></a></li>
		<li class="sell-mn05"><a href="#">결제 완료<span class="count">13</span></a></li>
		<li class="sell-mn06"><a href="#">수령<span class="count">2</span></a></li>
		<li class="sell-mn07"><a href="#">삭제<span class="count">21</span></a></li>
		<li class="sell-mn08"><a href="#">취소<span class="count">113</span></a></li>
		<li class="sell-mn09"><a href="#">거절<span class="count">101</span></a></li>
		<li class="sell-mn10"><a href="#">수량 부족<span class="count">3</span></a></li>
		<li class="sell-mn11 current"><a href="#">반품 선적 완료<span class="count">2</span></a></li>
	</ul>
	<ul class="menu2">
		<li class="sell-mn12"><a href="#">불량 통보<span class="count">3</span></a></li>
		<li class="sell-mn13"><a href="#">동의서<span class="count">2</span></a></li>
		<li class="sell-mn14"><a href="#">반품 선적 완료<span class="count">5</span></a></li>
		<li class="sell-mn15"><a href="#">거절<span class="count">2</span></a></li>
		<li class="sell-mn16"><a href="#">결제 완료<span class="count">2</span></a></li>
		<li class="sell-mn17"><a href="#">결과 공지<span class="count">2</span></a></li>
		<li class="sell-mn18"><a href="#">수령<span class="count">2</span></a></li>
		<li class="sell-mn19 last"><a href="#">종료<span class="count">3</span></a></li>
	</ul>
</div>
<!-- //layer-left-menu -->
...
<div class="layer-content">
	...
	<div class="btn-area t-rt">
		<a href="#"><img src="/kor/images/btn_answer.gif" alt="회신서"></a>
	</div>
	<!-- //layer-btn -->
</div>
<!-- //layer-content -->