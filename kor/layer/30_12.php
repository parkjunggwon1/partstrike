...
<div class="layer-content">
	...
	<div class="btn-area t-ct" odr_idx="<?=$odr_idx?>" odr_det_idx="<?=$odr_det_idx?>" tot_amt="<?=$tot_amt?>" fromLoadPage="<?=$fromLoadPage?>" deposit_yn="<?=$deposit_yn?>" charge_type="<?=$charge_type?>"  >
		<a href="#" class="f-lt btn-pop-18-2-11"  odr_idx="<?=$odr_idx?>" odr_det_idx="<?=$odr_det_idx?>" fromLoadPage="<?=$fromLoadPage?>" charge_type="<?=$charge_type?>" memfee_id="<?=$memfee_id?>" tot_amt="<?=$tot_amt?>"><img src="/kor/images/btn_mybank.gif" alt="my bank"></a>
