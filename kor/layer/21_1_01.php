...
<div class="sheet-wrap">
	...
	<div class="order-table">
		...
		<?echo GET_RCD_DET_LIST_V2(" and odr_idx=$odr_idx and odr_det_idx =$odr_det_idx" ,"21_1_01"); ?>			
	</div>
	<!-- //order-table -->
	...
	<div class="btn-area t-rt">
		...
		<a href="#" class="btn-dialog-21-1-06" odr_idx ="<?=$odr_idx?>"  odr_det_idx="<?=$odr_det_idx?>"><img src="/kor/images/btn_return_way.gif" alt="반품 방법"></a>
		<?}else{?>
		<a href="#" class="agreeConfirm" odr_idx ="<?=$odr_idx?>" odr_det_idx="<?=$odr_det_idx?>" agreement_no="<?=$row_odr_det["agreement_no"]?>"  reason_ty="4"><img src="/kor/images/btn_agree.gif" alt="동의"></a>
