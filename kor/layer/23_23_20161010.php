...
<div class="sheet-wrap">
	<div class="top-info">
		...
		<ul class="contact-info">
			...
			<li><span class="tel">Contact : <?=$row_odr["rel_idx"]==0?$row_buyer["pos_nm_en"]:get_any("member", "mem_nm_en", "mem_idx=".$row_odr["mem_idx"])?> / <?=$row_odr["rel_idx"]==0?"CEO":get_any("member", "pos_nm_en", "mem_idx=".$row_odr["mem_idx"])?></li>
		</ul>
	</div>	
