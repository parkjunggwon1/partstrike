...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li><a href="#" class="sell-mn10">1</a></li>
			<li class="current"><a href="#" class="sell-mn10-1914">2</a></li>
	...
	<div class="layer-file">
		<table>
			<tbody>
				...
				<tr>
					<td>
						<div class="re-select"><strong>선택</strong><em>추가 선적</em><!--<em>반품</em>--></div>
					</td>
	...
	<div class="btn-area t-rt">
		<a href="#" class="btn-pop-1916"><img src="/kor/images/btn_add_shipping.gif" alt="추가 선적"></a>
