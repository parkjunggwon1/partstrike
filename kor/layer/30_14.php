<?
/**************************************************************************************
*** What's New : 결제 완료(구매자) 30_14, 판매자가 부대비용(운송료등) 결재한 내역
**************************************************************************************/
		...
		<table>
			<tbody>
				<tr>		
					...
					<td class="c-red2 w100 t-ct"><!--결제완료된 내역이 없습니다.--></td>
				</tr>
			</tbody>
		</table>
	</div>	
<?}else{
	...
	<div class="layer-content">
		...
		<!-- //layer-pagination -->
		<?//=GET_ODR_HISTORY_LIST("30_15", $odr_idx)?>
		<?=GET_ODR_HISTORY_LIST("30_14", $odr_idx, $odr_det_idx)?>
	</div>
	<!-- //layer-content -->
<?}?>
<SCRIPT Language="javascript">
	$(document).ready(function(){
		$("#data_30_14 .stock-list-table tbody:eq(0) tr:eq(0) td").addClass("first");
	});
</SCRIPT>