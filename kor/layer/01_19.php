...
<div class="layer-content">
	<form>
		...
		<div class="mr-tb15 t-ct">
			<label class="c-red2" lang="en"><span>충전금액 </span><input type="text" name="rqst_amt" id="rqst_amt" class="i-txt2 c-blue t-rt onlynum numfmt" maxlength="11" value="" style="width:67px"></label>
		</div>
