...
<div class="layer-content">
	...
	<div class="btn-area t-ct" odr_idx="<?=$odr_idx?>" odr_det_idx="<?=$odr_det_idx?>" fromLoadPage="<?=$fromLoadPage?>" deposit_yn="" charge_type="<?=$charge_type?>" tot_amt="<?=$tot_amt?>">
		<a href="#" class="f-lt btn-pop-21-1-12" odr_idx="<?=$odr_idx?>" odr_det_idx="<?=$odr_det_idx?>" fromLoadPage="<?=$fromLoadPage?>" charge_type="<?=$charge_type?>" memfee_id="<?=$memfee_id?>" tot_amt="<?=$tot_amt?>"><img src="/kor/images/btn_mybank.gif" alt="my bank"></a>
