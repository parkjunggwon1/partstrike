...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li><a href="#" class="buy-mn07">1</a></li>
			<li class="current"><a href="#" class="buy-mn07-18-2-15">2</a></li>
		...
		<table>
			<tbody>
				<tr>
					...
					<td class="c-red2 w100 t-ct">부대비용 (<strong class="c-blue"><span lang="en">US$0,000.00 - My Bank</span></strong>) 결제가 완료되었습니다.</td>
				</tr>
			</tbody>
		</table>
	</div>
