...
<div class="layer-content">
	...
	<div class="layer-pagination">
		<ul>
			...
			<li><a href="#" class="buy-mn13">1</a></li>
			<li class="current"><a href="#" class="buy-mn13-18-1-02">2</a></li>
			<li><a href="#">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
	...
	<div class="btn-area t-rt">
		<a href="#" class="btn-dialog-18-1-04"><img src="/kor/images/btn_return_shipping.gif" alt="반품선적"></a>
	</div>
	<!-- //layer-btn -->
</div>
<!-- //layer-content -->