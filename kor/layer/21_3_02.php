...
<div class="layer-content">
	...
	<div class="layer-pagination red">
		<ul>
			...
			<li><a href="#" class="sell-mn13">1</a></li>
			<li class="current"><a href="#" class="sell-mn13-21-3-02">2</a></li>
			<li><a href="#">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
	...
	<div class="layer-file">
		<table>
			<tbody>
				<tr>
					<td class="company" rowspan="2"><img src="/kor/images/nation_title_uk.png" alt="United Kingdom"> <span class="name">DigitalDream Co., Ltd</span></td>
					<td class="c-red2 w100 t-ct" rowspan="2">동의서가 도착했습니다.</td>
					<td class="file t-rt">
	...
	<div class="btn-area t-rt">
		<a href="#" class="btn-view-sheet-21-1-01"><img src="/kor/images/btn_consent_form.gif" alt="동의서"></a>
	</div>
	<!-- //layer-btn -->
</div>
<!-- //layer-content -->