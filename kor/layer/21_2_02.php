...
<div class="layer-content">
	...
	<div class="layer-pagination red">
		<ul>
			...
			<li><a href="#" class="buy-mn23">1</a></li>
			<li class="current"><a href="#" class="buy-mn23-21-2-02">2</a></li>
			<li><a href="#">3</a></li>
			<li><a href="#">4</a></li>
			<li><a href="#">5</a></li>
			<li><a href="#">6</a></li>
	...
	<div class="layer-step">
		<ol>
			...
			<li class="c2">
				<span class="date">Day, Month, 2014</span>
				<strong class="status">동의서</strong>
				<span class="etc">AS14-PS00001A</span>
			</li>
			<li>
				<span class="date">Day, Month, 2014</span>
				<strong class="status">동의서</strong>
			...
			<li class="c2">
				...
				<span class="etc"><img alt="DHL" src="/kor/images/icon_dhl.gif"><br>-XXXXXXXXX</span>
			</li>
		</ol>
	</div>
	<!-- //layer-step -->
	...
	<div class="layer-file">
		<table>
			<tbody>
				<tr>
					<td class="c-red2">운송회사 : <img alt="" src="/kor/images/icon_dhl.gif"> &nbsp;&nbsp;&nbsp;<span lang="en">Account No. :</span> <span class="c-blue" lang="en">XXXXXXXXX</span></td>
		...
		<table class="stock-list-table">
			...
			<tbody>
				...
				<tr>
					...
					<td>$10,000.00</td>
					<td>$10,000.00</td>
					<td class="c-blue">Cosmotron Co., Ltd.</td>
				</tr>
				<tr class="bg-none">
					<td></td>
					<td colspan="10">
	...
	<div class="btn-area t-rt">
		<a href="#" class="btn-dialog-21-2-03"><img alt="반품선적" src="/kor/images/btn_return_shipping.gif"></a>
	</div>
	<!-- //layer-btn -->
</div>
<!-- //layer-content -->