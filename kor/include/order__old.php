...
<!-- table -->
			...
			<input type="hidden" name="odr_type" id = "odr_type" value="<?=$odr_type?>">
						...
						<tbody>
							<tr>
								<td class="title-box" colspan="3">
									<div class="mr-tb5"><img alt="Special Price Stock" src="/kor/images/nation_title_uk.png"> <span class="c-blue" lang="en">ABC Co., Ltd</span></div>
								</td>
							</tr>
							<tr>
								<td>377</td>
				...
				</div>--><?=GET_TURNKEY_ODRDET_LIST($odr_type, " and b.part_type=7 and a.".($odr_type=="S"?"sell_":"")."mem_idx=$this_mem_idx ", "S")?>
				</form>
			</section>
			<!--// table -->