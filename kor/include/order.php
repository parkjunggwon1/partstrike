			...
			<input type="hidden" name="odr_type" id = "odr_type" value="<?=$odr_type?>">
				<div class="hd-type-wrap">
					<table class="stock-list-table bg-type4">
						...
						<tbody id="orderlist">
						<?//	for ($i = 1; $i<=6; $i++){
							echo GET_RCD_DET_LIST($i , $odr_type, " and a.".($odr_type=="S"?"sell_":"")."mem_idx=$this_mem_idx AND a.odr_status IN(1,2,16,18,19,20,31) ", "S");
						//}?>							
						</tbody>
					</table>
				</div>
			...
			<input type="hidden" name="odr_type" id = "odr_type" value="<?=$odr_type?>">
				<div class="hd-type-wrap">
					<table class="stock-list-table bg-type4">
						...
						<tbody id="orderlist">
						<?//	for ($i = 1; $i<=6; $i++){
							echo GET_RCD_DET_LIST($i , $odr_type, " and a.".($odr_type=="S"?"sell_":"")."mem_idx=$this_mem_idx AND a.odr_status NOT IN(1,2,16,18,19,20,31)", "S");
						//}?>							
						</tbody>
					</table>
				</div>
