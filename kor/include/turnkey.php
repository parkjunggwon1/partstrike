	...
	//-->
			...
			<section id="stockTop" class="box-type1">
				...
				<input type="hidden" id="part_type" name="part_type" value="7">
					...
					<span class="op4"><label class="c-red " lang="en">Price </label><label class="c-blue"></label><input type="text" style="width:76px" class="i-txt2 c-blue t-rt onlynum numfmt" maxlength="11" name="price" id="price" value="" placeholder=""> 
