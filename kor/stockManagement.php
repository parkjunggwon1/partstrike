	...
	<div id="partsContent" class="container">
		<div class="col-left">
				...
				<table class="stock-list-table">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="i-txt2" style="width:45px" value="NEW"></td>
							<td>
							...
							<td><input type="text" class="i-txt2" style="width:66px" value="1,000,000"></td>
			...
			<section id="stockManage" class="box-type1">
				<form>
					<div class="box-top bg2">
						<div class="op1"><label lang="en">Part No. <input type="text"></label><button type="submit"><img src="/kor/images/btn_srch2.gif" alt="검색"></button></div>
						<h2>재고편집</h2>
						<a href="#"><img src="/kor/images/btn_stock_list_down.gif" alt="재고목록 download"></a>
					</div>
					<table class="stock-list-table">
						<thead>
							<tr>
						...
						<tbody>
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="254"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="12"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="14"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="153"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="21"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="11"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="10"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="41"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="2"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="1"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="112"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="211"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="222"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
							...
							<tr>
								...
								<td><input type="text" class="i-txt2" style="width:155px" value="ManuManuManuManuManu"></td>
								<td><input type="text" class="i-txt2 w-50" style="width:76px" value="PackaPacka"></td>
								<td><input type="text" class="i-txt2" style="width:45px" value="111"></td>
								<td>
									<div class="select type4" lang="en" style="width:60px">
										<label>RoHS</label>
										<select>
			...
			<script>
				$(document).ready(function(){
					...
					$("#popUp").load("/kor/layer/layerPop.php");
				})
			</script>
