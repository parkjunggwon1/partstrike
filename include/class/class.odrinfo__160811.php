...
<?	
			...
			<tr class="bg-none">
				...
				<td colspan="10">		
				 <div class="txt_option" style="display:none;margin-left:-580px;"><img src="/kor/images/txt_option.gif" alt="선적Option을 선택하여 발주서를 각각 발행할 수 있습니다.발주서 기준 최종 납기 제품과 일괄 배송됩니다." /></div>
					...
					<div class="company-info-wrap" style="display:<?if (!$delivery_addr_idx){echo"none";}?>">
						<?echo GET_CHG_ODR_DELIVERY_ADDR($delivery_addr_idx,$loadPage);?>
					</div>
	...
	//****************** 배송지 변경 *********************************************************************************************
	//****************************************************************************************************************************
	function GET_CHG_ODR_DELIVERY_ADDR($delivery_addr_idx,$loadPage=""){
		if ($delivery_addr_idx){
			$result = QRY_DELIVERY_ADDR_VIEW($delivery_addr_idx);
			$row = mysql_fetch_array($result);
			if ($row){
	...
	<script type="text/javascript">
		...
		//-->
			...
			$(".company-info-wrap input,select").change(function(){
				...
				var save_ok = false;
				//공통 필수(회사구분,국가,성명,휴대전화,우편번호,도시,시군구,주소,email)
				if(MustChk() == true){
					save_ok = true;
				}
	...
	<table class="company-info-tb" style="width:745px">
		<tbody>
			...
			<tr>
				...
				<td colspan="2">
					<div class="select type5 bd2" lang="ko" style="width: 215px;">
						<label class="c-blue"><?=($nation)?GF_Common_GetSingleList("NA",$nation):""?></label>
						<?echo GF_Common_SetComboList("nation", "NA", "", 1, "True",  "", $nation  , "onchange='chgnation(this);' lang='en' id='must_field'");?>
					</div>
				</td>
			</tr>
			<tr class="indivi">
			...
			<tr>
				...
				<td colspan="2"><input class="i-txt5 c-blue" type="text" maxlength="30" lang="ko" name="manager" id="must_field" style="width:215px" value="<?=$manager?>"></td>
			</tr>
			<tr class="indivi">
			...
			<tr>
				...
				<td colspan="2"><input class="i-txt5 c-blue" name="hp" id="must_field" type="text" maxlength="15" lang='en' style="width:215px" value="<?=$hp?>"></td>
			</tr>
			<tr>
				<th scope="row"><strong class="c-red">*</strong> 우편번호</th>
				<td colspan="2"><input class="i-txt5 c-blue" name="zipcode" id="must_field" type="text" maxlength="10" style="width:215px"  lang='en' value="<?=$zipcode?>"><span class="c-red">&nbsp;&nbsp;
			...
			<tr>
				...
				<td colspan="2">
					<div class="select type6 bd2" lang='en' style="width: 215px;display:<?=($dosi!=""|| ($dosi=="" && $dositxt==""))?"":"none"?>;">
						...
						<?=GF_Common_SetComboList("dosi", "NA", $nation, 2, "True",  "", $dosi , "onchange='chgdosi(this);' lang='ko' id='must_field'");?>
					</div>

					<input type="text" onkeyup="chgdositxt(this,'');" class="i-txt5 c-blue" name="dositxt" id="must_field" id="dositxt" lang='en' value="<?=$dositxt?>" style="width:215px;display:<?=$dositxt!="" ?"":"none"?>;" >
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input class="i-txt5 c-blue w100" name="addr" lang='en' value="<?=$addr?>" type="text"></td>
