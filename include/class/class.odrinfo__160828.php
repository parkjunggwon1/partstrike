	...
	<table class="company-info-tb" style="width:745px">
		<tbody>
			...
			<tr>
				...
				<td colspan="2">
					<div class="select type5" lang='en' style="width: 215px;display:<?=($dosi!=""|| ($dosi=="" && $dositxt==""))?"":"none"?>;">
			...
			<tr>
				...
				<td colspan="2"><input class="i-txt3 c-blue w50" name="addr_det" id="addr_det" value="<?=$addr?>" type="text" lang="ko"></td>
			</tr>
			<tr>
				<th scope="row" style="height:20px;"><strong class="c-red">*</strong>  주소</th>
