						...
						<td colspan="11">
							<table class="detail-table">
								<tbody>
									...
									<tr>
										<td colspan="2" lang="en"><strong class="c-black">Memo : </strong> <input type="text" class="i-txt3" name="memo[]" value="" style="width:388px"></td>
									</tr>
								</tbody>
							</table>
						</td>
					...
					<?}elseif ($loadPage == "30_16" ||$loadPage=="18R_21"){ //[판매자] 선적(30_16)/교환선적시 보여지는 내용?>
						...
						<td colspan="10">
							<table class="detail-table">
								...
								<tr class="yesinput"  style="display:none;">
									<td colspan="4" lang="en"><strong class="c-black">Memo : </strong> <input type="text" class="i-txt3" name="memo" value="<?=$memo?>" style="width:294px"></td>
								</tr>
								<tr>
										<td colspan="4" class="img-cntrl-list">
											<strong class="c-red">라벨/부품사진 :</strong>
	...
	<table class="company-info-tb" style="width:745px">
		<tbody>
			...
			<tr>
				...
				<td colspan="2">
									<div class="select type5" lang="en">
										<label lang="en"><?=($nation)?GF_Common_GetSingleList("NA",$b_nation):"Nation"?></label>
										<?=GF_Common_SetComboList("nation", "NA", "", 1, "True",  "", $b_nation , "onchange='chgnation(this);'");?>
									</div>
				</td>
			</tr>
			<tr class="indivi">
				<th scope="row"><strong class="c-red">*</strong> <span id="sp_com_nm">회사명</span></th>
				<td colspan="2"><input class="i-txt3 c-blue" maxlength="30" lang="ko" type="text" name="com_name" style="width:215px" value="<?=$com_name?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input class="i-txt3 c-blue" name="tel" type="text" maxlength="15" lang='en' style="width:215px" value="<?=$tel?>"></td>
			</tr>
			<tr>
				<th scope="row"><strong class="c-red"></strong> <span lang="en">Fax</span></th>
				<td colspan="2"><input class="i-txt3 c-blue" name="fax"  type="text" maxlength="15" lang='en' style="width:215px" value="<?=$fax?>"></td>
			</tr>
			<tr>
				<th scope="row"><strong class="c-red">*</strong> 휴대전화</th>
				<td colspan="2"><input class="i-txt3 c-blue" name="hp" type="text" maxlength="15" lang='en' style="width:215px" value="<?=$hp?>"></td>
			</tr>
			<tr>
				<th scope="row"><strong class="c-red">*</strong> 우편번호</th>
				<td colspan="2"><input class="i-txt3 c-blue" name="zipcode" type="text" maxlength="10" style="width:215px"  lang='en' value="<?=$zipcode?>"><span class="c-red">&nbsp;&nbsp;
			...
			<tr>
				...
				<td colspan="2">
					<div class="select type5" id="dv_dosi" lang='en' style="width: 215px;display:<?=($dosi!=""|| ($dosi=="" && $dositxt==""))?"":"none"?>;">
					...
					<input type="text" onkeyup="chgdositxt(this,'');" class="i-txt3 c-blue" name="dositxt" id="dositxt" lang='en' value="<?=$dositxt?>" style="width:215px;display:<?=$dositxt!="" ?"":"none"?>;" >
				</td>
			</tr>
			<tr>
				<th scope="row"><strong class="c-red">*</strong> 시/군/구</th>
				<td colspan="2">
				    <input type="text" onkeyup="chgsigungu(this,'');" class="i-txt3 c-blue" maxlength="30" style="width:215px"  lang='en' name="sigungu" id="sigungu" value="<?=$sigungu?>">
				</td>
			</tr>
			<tr>
				<th scope="row"><strong class="c-red">*</strong> 상세주소</th>
				<td colspan="2"><input class="i-txt3 c-blue w50" name="addr_det" lang='en' value="<?=$addr?>" type="text"></td>
			</tr>
			<tr>
