...
$pay = "";
//***************************************************** GET_ODR_DET_LIST *****************************************************************
function GET_ODR_DET_LIST($loadPage, $part_type, $searchand, $det_cnt = 0){   //part_type별 odr list 출력 (05_04 ,30_06, 30_08,30_15등등 layer에서 사용)
			...
			?>
				...
				<tr>
					<td colspan="<?=$colspan?>" class="title-box <?if ($part_type=="1"){?>first<?}?>">
						...
						<?if ($loadPage=="05_04"){?>
						<div class="txt_stock" style="display: none; float:right; width:136px; padding:0 0 0 0;<?=($per_cnt>0)? " margin-right:50px;":" margin-right:-13px;";?>"><img src="/kor/images/txt_stock_r1.gif" alt="재고수량 이하로 입력"></div>
						<?}?>
					</td>
				</tr>
			<?}?>
			...
			<tr id="tr_<?=$odr_det_idx?>"><!------------ 내용 첫 번째 tr -------------->
				...
				<?}elseif ($loadPage== "31_05"){?>
					...
					<?if ($part_type=="7"){?>
						<td colspan="6"><input type="text" class="i-txt4" value="<?=$part_no?>" style="width:560px; ime-mode:disabled" readonly></td>					
					<?}else{?>
					<td class="t-lt"><?=($per_cnt>0)? cut_len($part_no,18,"."):$part_no?></td>
					<td class="t-lt"><?=($per_cnt>0)? cut_len($manufacturer,14,"."):$manufacturer?></td>
					...
					<td class="t-rt">
						...
						<input type="text" class="i-txt0 c-blue  onlynum numfmt t-rt" maxlength="10" name="odr_quantity[]" odr_det_idx="<?=$odr_det_idx?>" value="<?=$odr_quantity==0?"":number_format($odr_quantity)?>" style="width:56px;" readonly>
						<?}else{?>
						<input type="text" class="i-txt2 c-blue  onlynum numfmt t-rt" maxlength="10" name="odr_quantity[]" odr_det_idx="<?=$odr_det_idx?>" value="<?=$odr_quantity==0?"":number_format($odr_quantity)?>" style="width:56px;">
						<?}?>
					</td>
				...
				<?}elseif  ($loadPage== "30_08"){ //-------------- 30_08 : 판매자 페이지에서 보여지는 송장 내용?>
					<td>
						<label class="ipt-chk chk2">
					...
					<?}else{?>
					<td class="t-lt"><input type="text" class="i-txt4" name="part_no[]" value="<?=$part_no?>" maxlength="30" style="width:184px; ime-mode:disabled" ></td>
					<td class="t-lt"><input type="text" class="i-txt4" name="manufacturer[]" value="<?=$manufacturer?>" maxlength="20" style="width:146px; ime-mode:disabled" ></td>
					<td><input type="text" class="i-txt4" name="package[]" value="<?=$package?>" maxlength="10" style="width:64px; ime-mode:disabled" ></td>
					<td><?=$dc?></td>
					<td><?=$rhtype?></td>
					<td class="t-rt"><?=$quantity==0?"":number_format($quantity)?></td>
					<?}?>
					<td class="t-rt">$<?=number_format($price,2)?></td>
					<td><span class="c-blue"><?=$odr_quantity==0?"":number_format($odr_quantity)?></span></td>
					<td><input type="text" name="supply_quantity[]" class="i-txt4 c-red2 onlynum numfmt t-rt" value="<?=$odr_quantity==0?"":number_format($odr_quantity)?>" maxlength="10" style="width:58px"></td>
						...
						<td colspan="11">
							<table class="detail-table">
								<tbody>
									...
									<tr>
										<td colspan="4" lang="en"><strong class="c-black">Memo : </strong> <input type="text" class="i-txt5" name="memo[]" value="" style="width:294px"></td>
									</tr>
								</tbody>
							</table>
						</td>
				<?}elseif  ($loadPage== "po_cancel"){ //-------------- 판매자 송장 품목 취소(삭제)?>
					...
					<td class="t-rt">$<?=number_format($price,2)?></td>
					<td><span class="c-blue"><?=$odr_quantity==0?"":number_format($odr_quantity)?></span></td>
					<td><?=$odr_quantity==0?"":number_format($odr_quantity)?></td>
					<?=($period)?"<td class='c-red'>".$period:(($part_type=="2"||$part_type=="5"||$part_type=="6")?"<td class='c-red'><span lang='ko'>확인</span>":"<td>Stock")?></td>
					</tr>
					<tr>
						<td></td>
						<td colspan="11">
							<table class="detail-table">
								<tbody>
									...
									<tr>
										<td lang="en" class="t-lt"><strong class="c-black">사유 : </strong> <input type="text" class="i-txt2 c-blue w100" name="reason[]" value="" style="width:294px"></td>
									</tr>
									<tr>
										<td lang="en" class="c-red2">취소 시 ‘발주 취소’ 항목의 숫자가 증가할 것입니다.</td>
									</tr>
								</tbody>
							</table>
						</td>
					...
					?>
						<?if ($loadPage =="18R_19" ||$loadPage =="04_01" || $loadPage=="30_20"){?><td><label class="ipt-chk chk2">
						...
						<td class="c-blue"><?=$odr_quantity==0?"":number_format($odr_quantity)?></td>
						<?if ($loadPage !="21_04" ){?>
								<?if($loadPage!="02_02"&& $loadPage !="05_04_1"){?><td class="c-red"><?=$supply_quantity==0?"":number_format($supply_quantity)?></td><?}?>
								<?=($period)?"<td class='c-red'>".(QRY_CNT("odr_history", "and  odr_idx = $odr_idx and status = 19 ")>0?"Stock":$period):(($part_type=="2"||$part_type=="5"||$part_type=="6")?"<td class='c-red'><span lang='ko'>확인</span>":"<td>Stock")?></td>
						<?}?>
						<?if ($loadPage!="31_06" && $loadPage!="02_02"){?>
						<?if ($loadPage !="18R_06" && $loadPage != "03_02"&& $loadPage != "04_01"){?>
						<td class="c-blue"><?
							if($loadPage!="05_04_1" || ($loadPage=="05_04_1" && $sell_mem_idx != $_SESSION["MEM_IDX"])){
						?><a href="javascript:layer_company_det(<?=$com_idx?>);"><?=$company_nm?></a><?
							}?></td><?
						}?>
					</tr>
					...
					<td colspan="12">
						<table class="detail-table">
							<tbody>
								...
								<tr class="noinput">
									<td colspan="4" lang="en"><strong class="c-black">사유 : </strong><?=$det_reason;?> </td>
								</tr>
								<?}?>
								<?if ( $loadPage =="21_04" ){?>
								<tr>
						...
						?>
								...
								<?}elseif ( $loadPage == "19_06" || $loadPage =="19_08"  ||$loadPage =="18R_08" || $loadPage =="18R_19" || $loadPage =="18R_16"  ||$loadPage == "18R_06" || $loadPage == "18R_05" || $loadPage == "30_20"){?>
								<tr>
									<td colspan="4"  class="img-cntrl-list">
										<strong class="c-red">라벨/부품사진 :</strong>
										<?					
				...
				<tr class="bg-none">
					...
					<td colspan="10">
						<table class="detail-table mr-t0" align="center">
							<tbody>
								<tr>
									<td class="c-red2">운송회사 : <img src="/kor/images/icon_<?=strtolower(GF_Common_GetSingleList("DLVR",$ship[ship_info]))?>.gif" alt=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;운송장번호 : <input type="text" class="i-txt2 c-blue t-rt" name="delivery_no" value="" style="width:96px"></td>						
								</tr>
								<tr>
...
<!-- layer-step(거래단계 표기) -->
				...
				<tr><?
					...
					<?		 echo layerInvListData($loadPage ,$odr_idx, $odr_det_idx , $odr_history_idx);
						 ...
						 <?echo layerInvListData($loadPage ,$odr_idx,$odr_det_idx,$odr_history_idx);
						   ...
						   case "18R_16":
						   $return_method = $odr_his[return_method];
						?><td class="file"><span lang="ko"><input type="hidden" name="return_method" id="return_method" value="<?=$return_method?>"><?if ($return_method=="1"){ echo "반품포기";}?></span></td>
							<td class="file-memo" rowspan="2">Memo : <strong><?=$memo?></strong></td>
						</tr>
						<tr>
					...
					<table class="detail-table">
						<tbody>
							<tr>
								...
								<td style="width:130px"><span class="c-grey2">운송회사</span> <img src="/kor/images/icon_<?=strtolower(GF_Common_GetSingleList("DLVR",$row_ship["ship_info"]))?>.gif" alt="" height="15"></td>
								<th scope="row" style="width:80px"><span lang="en">Account No : </span></th>
								<td><span lang="en"><?=$row_ship["ship_account_no"]?></span></td>
							</tr>
							<tr>
								<td colspan="4" lang="en"><strong class="c-black">Memo : </strong><?=$row_ship["memo"]?></td>
							</tr>
							<tr>
								<th scope="row">운송보험 : </th>
								<td colspan="3" lang="en"><?=$row_ship["insur_yn"]=="o"?"Yes":"No"?></td>
							</tr>
						</tbody>
					</table>
				</td>
	...
	<div class="layer-data" id="data_<?=$loadPage?>">
		<table class="stock-list-table" id="list_<?=$loadPage?>">
			<thead>
				<tr>
					<?if ($loadPage =="18R_19" || $loadPage =="04_01" || $loadPage =="30_20"){?><th scope="col" style="width:50px">Option</th><?}?>
					...
					<?}?>
					<?if ($loadPage!="31_06" && $loadPage!="18R_06"&& $loadPage!="04_01" && $loadPage!="03_02" && $loadPage!="30_15"){?><th scope="col">Company</th><?}?>
				</tr>
			</thead>
			<?	for ($i = 1; $i<=7; $i++){
				echo GET_ODR_DET_LIST($loadPage,$i," and odr_idx=$odr_idx ".($odr_det_idx!="" && $odr_det_idx !="0"?"and odr_det_idx=$odr_det_idx":""));
			}
			?>             
		</table>        
	</div>
...
<?			}		
	...
	<?}elseif(($loadPage == "18R_06"  || $loadPage == "19_06") && strpos($_SERVER["PHP_SELF"], "18R_05")==""){				
	    ...
	    $fault_select = $odr_his[fault_select];
		 ...
		 <?}elseif($fault_select =="2"){?><a href="#" class="btn-dialog-18R15" fault_select="2"><img src="/kor/images/btn_return.gif" alt="반품"></a>
		 ...
		 <?}?>
		<a href="#" class="btn-dialog-<?=$loadPage=="18R_06"?"18R07":"1906"?>"><img src="/kor/images/btn_answer.gif" alt="회신서"></a>
	<?}elseif($loadPage == "18R_08" || $loadPage == "19_08"){
		?>
		<a href="#" class="btn-dialog-<?=$loadPage=="18R_08"?"18R09":"1908"?>"><img src="/kor/images/btn_reply.gif" alt="답변서"></a>
				 ...
				 <div class="txt_option" style="display:none;margin-left:-580px;"><img src="/kor/images/txt_option.gif" alt="선적Option을 선택하여 발주서를 각각 발행할 수 있습니다.발주서 기준 최종 납기 제품과 일괄 배송됩니다." /></div>
					...
					<table class="detail-table">
						...
						<div class="company-info-wrap" style="display:<?if (!$delivery_addr_idx){echo"none";}?>">
							...
							<?}?>
							<tr>
								<td colspan="4" lang="en"><strong class="c-black">Memo : </strong> <input type="text" class="i-txt<?=$ship_info=="6" || $ship_info=="5"?"2":"5"?>" id ="memo" name="memo" value="<?=$memo?>" style="width:339px"></td>
							</tr>
							<tr >
								<td  colspan="4"><label class="ipt-chk chk2" id="detail_delv"><input <?if ($ship_info=="6") {echo "disabled";}?> type="checkbox" id="insur_yn" name="insur_yn" <?if ($insur_yn=="o"){echo "checked class='checked'";}?>><span></span> 운송보험</label> <span class="c-red"> <?if ($insur_yn=="o"){echo ": Yes";}else{echo ": No";}?></span></td>
							</tr>
							<tr >
								<td  colspan="4"><label class="ipt-chk chk2 com-chck" id="detail_posi"><input type="checkbox" <?if ($ship_info=="6") {echo "disabled";}?> name="delivery_chg" id="delivery_chg"  <?if ($delivery_addr_idx){echo "checked class='checked'";}?>><span></span> 배송지 변경</label></td>
							</tr>
						</tbody>
					</table>
