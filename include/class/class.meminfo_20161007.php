...
<div class="box-top">
	<span class="left-btn"><a href="javascript:showajaxParam('.col-left', 'joinus' , 'typ=edit');"><img src="/kor/images/btn_back.gif" alt="이전"></a></span>
...
<table class="join-form-table">
	...
	<tbody>
		...
		<!--	<tr>
				...
				<td><input type="text" class="i-txt3" name="homepage" value="<?=$homepage?>"></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td> 
			</tr>-->
			<tr>
...
<?
	...
	<div><p class="c-red t-ct pd-tb20"> - 공식 대리점만 등록바랍니다. 확인 후 공식 대리점이 아닐 시 본사에서 삭제합니다. -
</p></div>
	<table class="option-table">
		<tbody>
			<tr>
	...
	<table class="stock-list-table bgno">
		<thead>
			<tr>
				...
				<th scope="col" class="th2 t-lt" style="width:177px"><span lang="ko"><?=get_variable_name($mem_type,"직원")?></span> ID</th>
				<th scope="col" class="th2 t-lt"><span lang="ko"><?=get_variable_name($mem_type,"직원")?> 성명/직책</span></th>
				<th scope="col" class="th2" style="width:51px"></th>
				<th scope="col" class="th2" style="width:51px"></th>
			</tr>
		...
		$sql = "select a.*, b.mem_id, b.mem_nm_en,depart_nm_en from agency a
