			...
			?>
				...
				<tr>
					<td colspan="<?=$colspan?>" class="title-box <?if ($part_type=="1"){?>first<?}?>">
						...
						<?if ($loadPage=="05_04"){?>
						<div class="txt_stock" style="display: none; float:right; width:136px; padding:0 0 0 0;<?=($per_cnt>0)? " margin-right:60px":"";?>"><img src="/kor/images/txt_stock.gif" alt="재고수량 이하로 입력"></div>
						<?}?>
					</td>
				</tr>
			<?}?>
