						...
						<td colspan="11">
							<table class="detail-table">
								<tbody>
									...
									<tr>
										<td colspan="2" lang="en"><strong class="c-black">Memo&nbsp;&nbsp;</strong> <input type="text" class="i-txt3 c-blue" name="memo[]" value="" style="width:388px"></td>
									</tr>
								</tbody>
							</table>
						</td>
				...
				<td colspan="9">
					<table class="detail-table">
						<tbody>
							...
							<tr>
								<td colspan="2" lang="ko"><strong class="c-black" lang="en">Memo : </strong><span class="c-blue"><?=$row_ship["memo"]?></span></td>
							</tr>
							<?}?>
	...
	<table class="company-info-tb" style="width:745px">
		<tbody>
			...
			<tr>
				...
				<td colspan="2">
					<input class="i-txt3 c-blue" name="zipcode" type="text" maxlength="10" style="width:215px"  lang='en' value="<?=$zipcode?>">
					<span class="c-red">&nbsp;&nbsp;
			...
			<tr>
				...
				<td colspan="2"><input class="i-txt3 c-blue w50" name="addr_det" id="addr_det" value="<?=$addr_det;?>" type="text" lang="ko"></td>
			</tr>
			<tr>
